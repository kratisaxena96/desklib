...
gulp.task('jshint', function() {
 ...
 gulp.task('build-js', function() {
   return gulp.src(['desklib/static/src/js/jquery.js','desklib/static/src/js/popper.min.js','desklib/static/src/js/bootstrap.js','desklib/static/src/js/owl.carousel.min.js','desklib/static/src/js/custom-typeahead.bundle.js','desklib/static/src/js/bloodhound.js','desklib/static/src/js/select2.js','desklib/static/src/js/custom.js','desklib/static/src/js/jquery.fileupload.js'])
  .pipe(sourcemaps.init())
